...
import by.aliesha.resource.PropertiesResourceManager;
...
public class Main {
    ...
    public static void main(String[] args) throws JAXBException, FileNotFoundException {
        ...
        ResourceBundle bundle2 = manager.getBundle("label",
    ...
    private static void generateTestFile() throws JAXBException,
        ...
        marshaller.marshal(resoures, new FileOutputStream(
                "resources/resources-test.xml"));
